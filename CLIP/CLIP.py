...
# import sys
# import subprocess
# subprocess.check_call([sys.executable,'pip','ftfy'])
...
text_ = "Running image captioning"
TTS.save_to_file(text_,'Meta.wav')
TTS.say(text_)
TTS.runAndWait()
...
image = cv2.imread("IP cam\Snap.jpg", cv2.IMREAD_COLOR)
...
# f = open("Text_Output.txt")
# 
text = generated_text_prefix
TTS.save_to_file(text,'Meta.wav')
TTS.say(text)
TTS.runAndWait()
